...
<div class="text-center font-bold text-xl">Football</div>
        ...
        <tr class={index === 0 ? "active" : ""}>
          ...
          <td>
            <div class="flex items-center space-x-3">
              <div class="avatar">
                <div class="mask mask-squircle w-12 h-12">
                  {#if team["Football"] === "HQ"}
                    ...
                    />
                  {:else if team["Football"] === "Johor Utara"}
                    <img
                      src={"/images/logo-johor-utara.png"}
                      alt="Avatar Tailwind CSS Component"
                    />
                  {:else if team["Football"] === "Johor Selatan"}
                    <img
                      src={"/images/logo-johor-selatan.jpg"}
                      alt="Avatar Tailwind CSS Component"
                    />
                  {:else if team["Football"] === "Rons"}
                    <img
              ...
              <div>
                <div class="font-bold">{team["Football"]}</div>
              </div>
            </div>
          </td>
          <td>
