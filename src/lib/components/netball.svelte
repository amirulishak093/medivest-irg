...
<div class="text-center font-bold text-xl">Netball</div>
        ...
        <tr class={index === 0 ? "active" : ""}>
          ...
          <td>
            <div class="flex items-center space-x-3">
              <div class="avatar">
                <div class="mask mask-squircle w-12 h-12">
                  {#if team["Netball"] === "HQ"}
                    ...
                    />
                  {:else if team["Netball"] === "Johor Utara"}
                    <img
                      src={"/images/logo-johor-utara.png"}
                      alt="Avatar Tailwind CSS Component"
                    />
                  {:else if team["Netball"] === "Johor Selatan"}
                    <img
                      src={"/images/logo-johor-selatan.jpg"}
                      alt="Avatar Tailwind CSS Component"
                    />
                  {:else if team["Netball"] === "Rons"}
                    <img
              ...
              <div>
                <div class="font-bold">{team["Netball"]}</div>
              </div>
            </div>
          </td>
          <td>
