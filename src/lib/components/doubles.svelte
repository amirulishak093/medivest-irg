            ...
            <div class="flex items-center space-x-3">
              <div class="avatar">
                <div class="mask mask-squircle w-12 h-12">
                  {#if team["Men's Singles"] === "HQ"}
                    <img
                      src={"/images/logo-hq.jpg"}
                      alt="Avatar Tailwind CSS Component"
                    />
                  {:else if team["Men's Singles"] === "Johor Utara"}
                    <img
                      src={"/images/logo-johor-utara.png"}
                      alt="Avatar Tailwind CSS Component"
                    />
                  {:else if team["Men's Singles"] === "Johor Selatan"}
                    <img
                      src={"/images/logo-johor-selatan.jpg"}
                      alt="Avatar Tailwind CSS Component"
                    />
                  {:else if team["Men's Singles"] === "Rons"}
                    <img
              ...
              <div>
                <div class="font-bold">{team["Men's Singles"]}</div>
