<script lang="ts">
  ...
  function calculateScoresFromData() {
    ...
    for (let i = 0; i < singles.length; i++) {
      if (i === 0) {
        addGold(singles[i]["Men's Doubles"]);
        addGold(singles[i]["Mix Doubles 1"]);
      } else if (i === 1) {
        addSilver(singles[i]["Men's Doubles"]);
        addSilver(singles[i]["Mix Doubles 1"]);
      } else if (i === 2) {
        addBronze(singles[i]["Men's Doubles"]);
        addBronze(singles[i]["Mix Doubles 1"]);
      }
    }
    ...
    for (let i = 0; i < doubles.length; i++) {
      ...
      if (i === 0) {
        addGold(doubles[i]["Men's Doubles"]);

      } else if (i === 1) {
        addSilver(doubles[i]["Men's Doubles"]);

      } else if (i === 2) {
        addBronze(doubles[i]["Men's Doubles"]);
